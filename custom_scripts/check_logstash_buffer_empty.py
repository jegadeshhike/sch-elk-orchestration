...
datapoints = cw.get_metric_statistics(period=60,start_time=(datetime.datetime.utcnow() - datetime.timedelta(seconds=300)), 
...
for dp in datapoints :
  ...
  if value > 0 :
    print 'Found datapoint ' + str(value) + '. Logstash Buffer is not empty.'
